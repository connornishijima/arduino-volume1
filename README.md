...
### Limitations
Unfortunately, cheating the Arduino's normal functions means we'll lose some of them.
...
This is because only pins 5 & 6 are driven by Timer0, *which can do PWM at a frequency higher than your hearing range!* It also means that while you're using Volume, normal `analogWrite()` use probably won't work on these pins.
